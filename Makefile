...
cclient$(FILE): cclient.c networks.o gethostbyname6.o packet_writer.o recieve.o
	$(CC) $(CFLAGS) -o cclient$(FILE) cclient.c networks.o gethostbyname6.o packet_writer.o recieve.o$(LIBS)

server$(FILE): server.c networks.o gethostbyname6.o arraylist.o packet_writer.o recieve.o
	$(CC) $(CFLAGS) -o server$(FILE) server.c networks.o gethostbyname6.o arraylist.o packet_writer.o recieve.o$(LIBS)
